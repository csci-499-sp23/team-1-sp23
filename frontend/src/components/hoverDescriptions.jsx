...
const hoverDescriptions = {
  ...
  'Attendance': {
    description: `Student Attendance refers to the percentage of enrolled students who attend school regularly. 
        Chronically Absent students are absent for 10% or more of the school year. 
        High Teacher Attendance ensures consistent access to high-quality instruction.`
  },
